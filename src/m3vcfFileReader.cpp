...
#include "m3vcfFileReader.h"

m3vcfFileReader::m3vcfFileReader()
    : m3vcfFile()
//      myVcfIndex(NULL),
//      myNewSection(false),
//      mySectionChrom(""),
...
bool m3vcfFileReader::open(const char* filename, m3vcfHeader& header)
{
    // Close an already open file.
    close();

    myStatus = StatGenStatus::SUCCESS;
    if(m3vcfFile::open(filename, "r"))
    {
...
//
//bool m3vcfFileReader::open(const char* filename, VcfHeader& header,
...
//        std::cerr << "m3vcfFileReader - failed to setup sample subsetting\n";
//    }
//
//    myUseSubset = true;
//
...
//
//// Read VCF Index file.
//bool m3vcfFileReader::readVcfIndex(const char* vcfIndexFilename)
//{
...
//
//// Read VCF Index file.
//bool m3vcfFileReader::readVcfIndex()
//{
//    if(myFilePtr == NULL)
//    {
...
//const Tabix* m3vcfFileReader::getVcfIndex()
//{
//    return(myVcfIndex);
//}
//
//
//bool m3vcfFileReader::readRecord(VcfRecord& record, VcfSubsetSamples* subset)
//{
//    myStatus = StatGenStatus::SUCCESS;
...
//
//
//bool m3vcfFileReader::setReadSection(const char* chromName)
//{
//    return(set1BasedReadSection(chromName, -1, -1));
//}
//
//
//bool m3vcfFileReader::set1BasedReadSection(const char* chromName,
...
//
//
//bool m3vcfFileReader::setExcludeIDs(const char* filename)
//{
//    return(myRecordDiscardRules.setExcludeIDs(filename));
//}
//
//
//bool m3vcfFileReader::setIncludeIDs(const char* filename)
//{
//    return(myRecordDiscardRules.setIncludeIDs(filename));
//}
//
//
//void m3vcfFileReader::addDiscardMinAltAlleleCount(int32_t minAltAlleleCount,
...
//
//
//void m3vcfFileReader::rmDiscardMinAltAlleleCount()
//{
//    myMinAltAlleleCount = UNSET_MIN_ALT_ALLELE_COUNT;
//    myAltAlleleCountSubset = NULL;
//}
//
//
//void m3vcfFileReader::addDiscardMinMinorAlleleCount(int32_t minMinorAlleleCount,
//                                                  VcfSubsetSamples* subset)
//{
...
//
//
//void m3vcfFileReader::rmDiscardMinMinorAlleleCount()
//{
...
void m3vcfFileReader::resetFile()
{
...
//
//bool m3vcfFileReader::processNewSection()
//{
//    myNewSection = false;
//
