...
#ifndef __M3VCF_FILE_READER_H__
#define __M3VCF_FILE_READER_H__
...
class m3vcfFileReader :  public m3vcfFile{
public:
    ...
    virtual bool open(const char* filename, m3vcfHeader& header);
...
private:
    m3vcfFileReader(const m3vcfFileReader& ThisRecord);
    m3vcfFileReader& operator=(const m3vcfFileReader& ThisRecord);
