...
class m3vcfBlockHeader
{

private:
    m3vcfBlockHeader(const m3vcfBlockHeader& thisRecord);
   // m3vcfBlockHeader& operator=(const m3vcfBlockHeader& thisRecord);
